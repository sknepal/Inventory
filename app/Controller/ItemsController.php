...
class ItemsController extends AppController
{
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->request->data['Item']['remaining_quantity'] <= $this->request->data['Item']['total_quantity']) {
                if ($this->Item->save($this->request->data)) {
                    $this->Session->setFlash(__('The item has been saved.'));
                    return $this->redirect(array('controller' => 'categories', 'action' => 'index'));
                } else {
                ...
                $this->Session->setFlash(__('Remaining quantity cannot be greater than total quantity.'));
            }
        } else {
            $options = array('conditions' => array('Item.' . $this->Item->primaryKey => $id));
